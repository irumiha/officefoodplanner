...
import org.codecannery.lunchplanner.domain.{PetAlreadyExistsError, PetNotFoundError}
import org.codecannery.lunchplanner.domain.pets.{Pet, PetService, PetStatus}
